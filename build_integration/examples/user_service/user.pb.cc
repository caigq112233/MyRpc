...
EchoRequest::EchoRequest()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_user_2eproto::scc_info_EchoRequest.base);
  SharedCtor();
...
const EchoRequest& EchoRequest::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_user_2eproto::scc_info_EchoRequest.base);
...
EchoResponse::EchoResponse()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_user_2eproto::scc_info_EchoResponse.base);
  SharedCtor();
...
const EchoResponse& EchoResponse::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_user_2eproto::scc_info_EchoResponse.base);
  return *internal_default_instance();
}
