...
// source: examples/user_service/user.proto

#include "examples/user_service/user.pb.h"
...
namespace protobuf_examples_2fuser_5fservice_2fuser_2eproto {
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "examples/user_service/user.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      "\n examples/user_service/user.proto\022\007exam"
      "ple\"\036\n\013EchoRequest\022\017\n\007message\030\001 \001(\t\"\037\n\014E"
      "choResponse\022\017\n\007message\030\001 \001(\t2B\n\013EchoServ"
      "ice\0223\n\004Echo\022\024.example.EchoRequest\032\025.exam"
      "ple.EchoResponseB\003\200\001\001b\006proto3"
  };
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
      descriptor, 189);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "examples/user_service/user.proto", &protobuf_RegisterTypes);
}
...
EchoRequest::EchoRequest()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_examples_2fuser_5fservice_2fuser_2eproto::scc_info_EchoRequest.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* EchoRequest::descriptor() {
  ::protobuf_examples_2fuser_5fservice_2fuser_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_examples_2fuser_5fservice_2fuser_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const EchoRequest& EchoRequest::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_examples_2fuser_5fservice_2fuser_2eproto::scc_info_EchoRequest.base);
...
::google::protobuf::Metadata EchoRequest::GetMetadata() const {
  protobuf_examples_2fuser_5fservice_2fuser_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_examples_2fuser_5fservice_2fuser_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
EchoResponse::EchoResponse()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_examples_2fuser_5fservice_2fuser_2eproto::scc_info_EchoResponse.base);
  SharedCtor();
...
const EchoResponse& EchoResponse::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_examples_2fuser_5fservice_2fuser_2eproto::scc_info_EchoResponse.base);
  return *internal_default_instance();
}
...
const ::google::protobuf::ServiceDescriptor* EchoService::descriptor() {
  protobuf_examples_2fuser_5fservice_2fuser_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_examples_2fuser_5fservice_2fuser_2eproto::file_level_service_descriptors[0];
}
...
void EchoService::CallMethod(const ::google::protobuf::MethodDescriptor* method,
                             ...
                             ::google::protobuf::Closure* done) {
  GOOGLE_DCHECK_EQ(method->service(), protobuf_examples_2fuser_5fservice_2fuser_2eproto::file_level_service_descriptors[0]);
  switch(method->index()) {
    case 0:
      Echo(controller,
